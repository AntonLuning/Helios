...
namespace Helios {
	...
	void ImGuiLayer::OnEvent(Event& event)
	{
		...
		dispatcher.Dispatch<WindowMovedEvent>(BIND_EVENT_FN(ImGuiLayer::OnWindowMovedEvent));
		dispatcher.Dispatch<WindowFocusEvent>(BIND_EVENT_FN(ImGuiLayer::OnWindowFocusEvent));
		dispatcher.Dispatch<WindowLostFocusEvent>(BIND_EVENT_FN(ImGuiLayer::OnWindowLostFocusEvent));
